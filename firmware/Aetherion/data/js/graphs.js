    ...
    Graphs.init = function() {
        ...
        document.querySelectorAll(".gtab").forEach(function(btn) {
            btn.addEventListener("click", function() {
                ...
                // Find canvas with matching data-graph
                var target = null;
                ids.forEach(function(id) {
                    if (canvases[id]) {
                ...
                Graphs.onResize();  // ensure canvas has correct dimensions
            });
        });
        ...
        // Register for throttled render (15 FPS bucket)
