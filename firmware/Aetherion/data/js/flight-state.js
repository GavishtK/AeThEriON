...
(function() {
    ...
    FlightState.detectState = function() {
        ...
        // --- RECOVERING: coming back to level ---
        var hist = AG.history;
        if (hist.length >= 5) {
    ...
    // =====================================================
    // STABILITY SCORE
    // (0-100 based on variance of roll, pitch, rates)
    // =====================================================
    ...
    FlightState.computeStability = function() {
        ...
        // Stability = 100 - weighted deviation
        var score = 100;
        score -= rollMean * 1.2;      // roll deviation penalty
        score -= pitchMean * 1.0;     // pitch deviation penalty
        score -= rateMean * 40;       // angular rate penalty
    ...
    // =====================================================
    // PUBLIC: get current state for recorder/analysis
    // =====================================================
